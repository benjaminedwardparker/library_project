...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { book_id: @checkout.book_id, check_in_by: @checkout.check_in_by, check_out_by: @checkout.check_out_by, patron_id: @checkout.patron_id }
    end
  ...
  test "should update checkout" do
    patch :update, id: @checkout, checkout: { book_id: @checkout.book_id, check_in_by: @checkout.check_in_by, check_out_by: @checkout.check_out_by, patron_id: @checkout.patron_id }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
